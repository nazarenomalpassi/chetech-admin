...
assert.deepEqual(buildRepairAccessCustomerSearchFilters("ma"), ["full_name.ilike.%ma%"]);
...
assert.deepEqual(buildRepairAccessCustomerSearchFilters("m,al%p"), ["full_name.ilike.%m al p%"]);
